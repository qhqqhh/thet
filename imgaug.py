...
if __name__ == "__main__":
    ...
    IMG_DIR = r"images/val"
    XML_DIR = r"labels/val"
    # IMG_DIR = r"xxx"
    # XML_DIR = r"yyy"

    # 存储增强后的影像文件夹路径
    AUG_IMG_DIR = r"Auguments/0img"
    mkdir(AUG_IMG_DIR)
    # 存储增强后的XML文件夹路径
    AUG_XML_DIR = r"Auguments/0xml"
    mkdir(AUG_XML_DIR)
    ...
    seq = iaa.SomeOf(2, [
        ...
        iaa.Add((-25,25), per_channel=True),
        iaa.CoarseDropout(0.02, size_percent=0.5),
        #iaa.Cartoon(),
        iaa.GaussianBlur(sigma=(0.0, 2.0)),
        iaa.WithHueAndSaturation([
            iaa.WithChannels(0, iaa.Add((-25, 25))),
            iaa.WithChannels(1, [
